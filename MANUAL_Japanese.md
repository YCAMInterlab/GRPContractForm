...
(7) 成果物についての表記、つまりクレジットについて定めています。主催者は、本プロジェクトの一切の成果について、共同研究機関と共同で制作された事を示すクレジットを表記します。これは将来にわたって行わなければなりません。なお、ここでいう利用にはコンペティションへの応募も含まれます。具体的なクレジットの表記については、別途協議して定めます。  
