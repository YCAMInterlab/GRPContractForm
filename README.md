...
デフォルトは英語でも良いのかな。他と揃える以外に考えることが有るとしたら、誰にみてもらいたいか、誰がみたがるか(影響が大きいか)、ということでしょうか。  
```
...
コンテンツとして提供する全ての文章、画像、音声情報について、内容の合法性・正確性・安全性等、あらゆる点において
保証しません。
リンクをしている外部サイトについては、何ら保証しません。
全記事とも、Creative Commons Attribution-ShareAlike 3.0 Unported License（以下、CC-BY-SA3.0 Unportedと略します）、
ほとんどの記事においてGNU Free Documentation License（以下、GFDLと略します）に基づく改変・再利用を許諾しますが、
